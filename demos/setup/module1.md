...
- [Module 1 setup: Realize Integrated Analytical Solutions with Azure Synapse Analytics](#module-1-setup-realize-integrated-analytical-solutions-with-azure-synapse-analytics)
  ...
  - [Before starting](#before-starting)
    ...
    - [Task 12: Power BI Dashboard](#task-12-power-bi-dashboard)
  - [Optional Features](#optional-features)
    - [30 Billion Rows Dataset](#30-billion-rows-dataset)
    - [Twitter Developer Account Application](#twitter-developer-account-application)
<!-- /TOC -->
...
1. Deploy the workspace through the following Azure ARM template (press the button below):
    ...
    <a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fsolliancenet%2Fsynapse-in-a-day%2Fmaster%2Fdemos%2Fsetup%2Fartifacts%2Fautomation%2F00-asa-workspace-core.json" target="_blank"><img src="http://azuredeploy.net/deploybutton.png" /></a>
